...
import views.memo.db.Memo;
import views.memo.db.MemoOperator;


public class AddMemoActivity extends AppCompatActivity implements DateRangePickerFragment.OnDateRangeSelectedListener, TimePickerDialog.OnTimeSetListener {
    ...
    private void setListener(){
        add_date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DateRangePickerFragment dateRangePickerFragment= DateRangePickerFragment.newInstance((DateRangePickerFragment.OnDateRangeSelectedListener) AddMemoActivity.this,false);
    ...
    public void Timepicker(View v) {
        timePickerDialog = TimePickerDialog.newInstance(AddMemoActivity.this, Hour, Minute,false );
        ...
        timePickerDialog.setOnCancelListener(new DialogInterface.OnCancelListener() {
            ...
            public void onCancel(DialogInterface dialogInterface) {
                Toast.makeText(AddMemoActivity.this, "Timepicker Canceled", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void save(){
        MemoOperator memoOperator = new MemoOperator(AddMemoActivity.this);
        ...
        if (TextUtils.isEmpty(memo.title) || TextUtils.isEmpty(String.valueOf(memo.year)) || TextUtils.isEmpty(String.valueOf(memo.hour))) {
            Toast.makeText(AddMemoActivity.this, "信息不能为空", Toast.LENGTH_SHORT).show();
        } else{
            boolean add = memoOperator.insert(memo);
            if (add) {
                Intent intent = new Intent();
                intent.setClass(AddMemoActivity.this, MemoActivity.class);
                intent.putExtra("Insert", 1);
                startActivity(intent);
            } else {
                Toast.makeText(AddMemoActivity.this, "添加失败", Toast.LENGTH_SHORT).show();
            }
        }
    }
}